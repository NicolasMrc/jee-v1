...
<html>
    <head>
        ...
        <script src="ressources/js/addIntern.js"></script>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="stagiaires-title text-center">Stagiaires non assignés</h1>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <c:choose>
                        <c:when test="${stagiaires.size() == 0}">
                            <div class="alert alert-primary" role="alert">
                                Tout les stagiaires sont affectés
                            </div>
                        </c:when>
                        <c:when test="${stagiaires.size() > 0}">
                            ...
                            <a class="btn btn-light disabled float-right" id="add"><i class="fa fa-floppy-o" aria-hidden="true"></i> Ajouter</a>
